...
- [COMP1531 Major Project](#comp1531-major-project)
  ...
  * [5. Iteration 3: Completing the Lifecycle](#5-iteration-3--completing-the-lifecycle)
    ...
    + [5.11. Peer Assessment](#511-peer-assessment)
  * [6. Interface specifications](#6-interface-specifications)
    + [6.1. Input/Output types](#61-input-output-types)
      - [6.1.1. Iteration 0+ Input/Output Types](#611-iteration-0--input-output-types)
      - [6.1.2. Iteration 1+ Input/Output Types](#612-iteration-1--input-output-types)
      - [6.1.3. Iteration 2+ Input/Output](#613-iteration-2--input-output)
      - [6.1.4. Iteration 3+ Input/Output](#614-iteration-3--input-output)
    + [6.2. Interface](#62-interface)
      - [6.2.3. Iteration 2 Interface](#623-iteration-2-interface)
      - [6.2.4. Iteration 3 Interface](#624-iteration-3-interface)
    + [6.3. Valid email format](#63-valid-email-format)
    + [6.4. Testing](#64-testing)
    + [6.5. Pagination](#65-pagination)
    + [6.6. Permissions](#66-permissions)
    + [6.7. User Sessions](#67-user-sessions)
    + [6.8. Working with the frontend](#68-working-with-the-frontend)
      - [6.8.1. Example implementation](#681-example-implementation)
      - [6.8.2. Error raising](#682-error-raising)
    + [6.9. Secure Sessions & Passwords](#69-secure-sessions---passwords)
    + [6.10. Notifications and tagging users](#610-notifications-and-tagging-users)
      - [6.10.1 Notifications](#6101-notifications)
      - [6.10.2 Tagging](#6102-tagging)
    + [6.11. Analytics](#611-analytics)
    + [6.12. Reacts](#612-reacts)
    + [6.13. Standups](#613-standups)
    + [6.14. profileImgUrl & image uploads](#614-profileimgurl---image-uploads)
  ...
  * [8. Individual Contribution](#8-individual-contribution)
    + [8.1. Project check-in](#81-project-check-in)
    + [8.2. Tutorial contributions](#82-tutorial-contributions)
    + [8.3. Code contribution](#83-code-contribution)
    + [8.4. Documentation contribution](#84-documentation-contribution)
    + [8.5. Peer Assessment](#85-peer-assessment)
    + [8.6. Managing Issues](#86-managing-issues)
  * [9. Automarking & Leaderboard](#9-automarking---leaderboard)
    + [9.1. Automarking](#91-automarking)
    + [9.2. Leaderboard](#92-leaderboard)
